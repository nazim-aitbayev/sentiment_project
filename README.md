...
Для демонстрации работы системы создан веб-интерфейс на FastAPI.

Пользователь вводит текст отзыва, после чего ML-модель определяет его тональность. Дополнительно AI-агент формирует краткое текстовое объяснение
